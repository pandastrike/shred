...
//   object](./content.html).
  ...
  content: {
    ...
    set: function(value) {
      ...
      this.body = this._content.body
      this.setHeader("Content-Type",this._content.type);
...
var processOptions = function(request,options) {
  ...
  // The request body can be set verbatim using a String in options.body, or 
  // it can be generated using a Content instance from options.content
  if (options.body) {
...
var createRequest = function(request) {
  ...
  if (request.body) {
    request.log.debug("Streaming body: '" +
        request.body.slice(0,59) + "' ... ");
    request._raw.write(request.body);
  }
